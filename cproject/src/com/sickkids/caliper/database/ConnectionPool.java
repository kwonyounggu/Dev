...
public class ConnectionPool implements Runnable, Serializable
{
	...
	private Connection makeNewConnection() throws SQLException
	{
		try
		{
			...
			/************* The following is newly added due to korean input through excecuteQuery(..) 
			 * didn't work. This is for adding unicode stuff.
			 */
			Properties info = new Properties();
		    ...
		    info.put("characterEncoding", "UTF-8");
//			 Load database driver if not already loaded
		    //if(driver.equals(DriverUtilities.getDriver(DriverUtilities.AS400)))
