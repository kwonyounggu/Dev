package com.sickkids.caliper.filters;
...
{	private FilterConfig filterConfig = null;
	...
	{	
		...
		{										
			...
			if(op==null)
			{
				//This is because HOME is recorded a lot of times in the database. - Jan 14, 2012
				chain.doFilter(request, response);//going to the servlets
				return;
			}
			ub.setOperation(((op==null)?"HOME": ("cproject: "+op)));
