...
public class VancouverActionController extends HttpServlet implements Servlet
{	static final long serialVersionUID = 1L;
	...
	{
		Utils.logger.info("doGet() is called in VancouverActionController.java");
		...
		Utils.logger.info("op="+op+" in VancouverActionController.java");
		...
		try
		{
			if(op==null || op.equals("home_vancouver") || op.equals(""))
			{
				request.setAttribute("body_panel", "/local_hospitals/vancouver/jsp/home_body.jsp");				
			}
			else if(op.equals("about_caliper_vancouver"))
			{
				request.setAttribute("body_panel", "/local_hospitals/vancouver/jsp/about_caliper_body.jsp");				
			}
			else if(op.equals("forms_vancouver"))
			{
				request.setAttribute("body_panel", "/local_hospitals/vancouver/jsp/forms.jsp");				
			}
			else if(op.equals("contactus_vancouver"))
			{
				request.setAttribute("body_panel", "/local_hospitals/vancouver/jsp/contactus.jsp");		
			}
			((RequestDispatcher)request.getRequestDispatcher("/local_hospitals/vancouver/jsp/page_template.jsp")).forward(request,response);
		}
		catch(Exception e)
		{	
