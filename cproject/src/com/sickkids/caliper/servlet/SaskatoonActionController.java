 ...
 */
public class SaskatoonActionController extends HttpServlet implements Servlet
{	static final long serialVersionUID = 1L;
	...
	{
		Utils.logger.info("doGet() is called in SaskatoonActionController.java");
		...
		Utils.logger.info("op="+op+" in SaskatoonActionController.java");
		...
		try
		{
			if(op==null || op.equals("home_saskatoon") || op.equals(""))
			{
				request.setAttribute("body_panel", "/local_hospitals/saskatoon/jsp/home_body.jsp");				
			}
			else if(op.equals("about_caliper_saskatoon"))
			{
				request.setAttribute("body_panel", "/local_hospitals/saskatoon/jsp/about_caliper_body.jsp");				
			}
			else if(op.equals("forms_saskatoon"))
			{
				request.setAttribute("body_panel", "/local_hospitals/saskatoon/jsp/forms.jsp");				
			}
			else if(op.equals("contactus_saskatoon"))
			{
				request.setAttribute("body_panel", "/local_hospitals/saskatoon/jsp/contactus.jsp");		
			}
			((RequestDispatcher)request.getRequestDispatcher("/local_hospitals/saskatoon/jsp/page_template.jsp")).forward(request,response);
		}
		catch(Exception e)
		{	
