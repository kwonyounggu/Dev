 ...
 */
public class HamiltonActionController extends HttpServlet implements Servlet
{	static final long serialVersionUID = 1L;
	...
	{
		Utils.logger.info("doGet() is called in HamiltonActionController.java");
		...
		Utils.logger.info("op="+op+" in HamiltonActionController.java");
		...
		try
		{
			if(op==null || op.equals("home_hamilton") || op.equals(""))
			{
				request.setAttribute("body_panel", "/local_hospitals/hamilton/jsp/home_body.jsp");				
			}
			else if(op.equals("about_caliper_hamilton"))
			{
				request.setAttribute("body_panel", "/local_hospitals/hamilton/jsp/about_caliper_body.jsp");				
			}
			else if(op.equals("forms_hamilton"))
			{
				request.setAttribute("body_panel", "/local_hospitals/hamilton/jsp/forms.jsp");				
			}
			else if(op.equals("contactus_hamilton"))
			{
				request.setAttribute("body_panel", "/local_hospitals/hamilton/jsp/contactus.jsp");		
			}
			((RequestDispatcher)request.getRequestDispatcher("/local_hospitals/hamilton/jsp/page_template.jsp")).forward(request,response);
		}
		catch(Exception e)
		{	
