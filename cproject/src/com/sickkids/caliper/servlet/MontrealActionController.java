 ...
 */
public class MontrealActionController extends HttpServlet implements Servlet
{	static final long serialVersionUID = 1L;
	...
	{
		Utils.logger.info("doGet() is called in MontrealActionController.java");
		...
		Utils.logger.info("op="+op+" in MontrealActionController.java");
		...
		try
		{
			if(op==null || op.equals("home_montreal") || op.equals(""))
			{
				request.setAttribute("body_panel", "/local_hospitals/montreal/jsp/home_body.jsp");				
			}
			else if(op.equals("about_caliper_montreal"))
			{
				request.setAttribute("body_panel", "/local_hospitals/montreal/jsp/about_caliper_body.jsp");				
			}
			else if(op.equals("forms_montreal"))
			{
				request.setAttribute("body_panel", "/local_hospitals/montreal/jsp/forms.jsp");				
			}
			else if(op.equals("contactus_montreal"))
			{
				request.setAttribute("body_panel", "/local_hospitals/montreal/jsp/contactus.jsp");		
			}
			else if(op.equals("contactus_montreal_french"))
			{
				request.setAttribute("body_panel", "/local_hospitals/montreal/jsp/contactus_fr.jsp");		
			}
			((RequestDispatcher)request.getRequestDispatcher("/local_hospitals/montreal/jsp/page_template.jsp")).forward(request,response);
		}
		catch(Exception e)
		{	
