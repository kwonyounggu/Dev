 ...
 */
public class OttawaActionController extends HttpServlet implements Servlet
{	static final long serialVersionUID = 1L;
	...
	{
		Utils.logger.info("doGet() is called in OttawaActionController.java");
		...
		Utils.logger.info("op="+op+" in OttawaActionController.java");
		...
		try
		{
			if(op==null || op.equals("home_ottawa") || op.equals(""))
			{
				request.setAttribute("body_panel", "/local_hospitals/ottawa/jsp/home_body.jsp");				
			}
			else if(op.equals("about_caliper_ottawa"))
			{
				request.setAttribute("body_panel", "/local_hospitals/ottawa/jsp/about_caliper_body.jsp");				
			}
			else if(op.equals("forms_ottawa"))
			{
				request.setAttribute("body_panel", "/local_hospitals/ottawa/jsp/forms.jsp");				
			}
			else if(op.equals("contactus_ottawa"))
			{
				request.setAttribute("body_panel", "/local_hospitals/ottawa/jsp/contactus.jsp");		
			}
			((RequestDispatcher)request.getRequestDispatcher("/local_hospitals/ottawa/jsp/page_template.jsp")).forward(request,response);
		}
		catch(Exception e)
		{	
