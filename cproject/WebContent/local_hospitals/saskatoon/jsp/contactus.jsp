				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 0px 20px 20px 20px; "> 	
						    ...
						    <td colspan=4 align="left">
								<table height="40" width="100%">
									...
									<img src='images/common/blue_circle.gif' width=16 height=17 valign="middle"/>
											<span style="font-weight:bold; font-size:12pt; font-family: arial;">Contact Us in Saskatoon Health Region</span>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial;">
											<img src='images/common/location_pin.png' width=16 height=16 valign="middle"/>&nbsp;&nbsp;<a href="<%= MenuLink.home_saskatoon %>" style="color: #5375CB;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;Contact Us
										</td>
									</tr>			
						...
						<tr><td colspan=2 width="50%"  style="padding-right: 40px; padding-bottom: 0px; padding-left: 40px; ">
								...
								<p> 
<!--									<img alt="Chantal Horth" src="images/main_body/22349-wMeng.jpg" style=" border: 1px solid blue; padding-left: 2px; float: right; padding-right: 2px; padding-top: 2px; padding-bottom: 2px;" title="Chantal Horth" />-->
									&nbsp;&nbsp;&nbsp;&nbsp;Dr. Qing Meng<br/>
							...
							<td colspan=2 width="50%" style="padding-left: 10px;" valign="top">
					...
					<br/>
					<table border=0 cellspacing=0 cellpadding=0 width='100%' height='320'> 	
						<tr><td></td></tr>
					</table>
				</td> 
