	...
	<tr> 
		...
		<td  bgcolor=#ffffff valign="top" align="center" style='padding-bottom: 0px;'> 
			<table align="center" border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 0px 0px 20px 0px; "> 	
				<tr><td colspan='2' align="center"><img src="local_hospitals/montreal/doc/montreal_home.gif" style="vertical-align: middle;" width="740" height="567" /></td></tr>	
				<tr>
				    <td colspan='2' align="center" valign="top" width='100%'>
						<table border=0 cellspacing=0 cellpadding=0 width='100%'>
							...
							<tr ><td style="padding-left: 90px; padding-right: 20px;" align="left" width='50%'>
									<span style="font-size:10pt; font-family: arial; vertical-align: middle;">							
										<p> 
									&nbsp;&nbsp;&nbsp;&nbsp;Dr. Edgard Delvin<br/>
								    &nbsp;&nbsp;&nbsp;&nbsp;Principal Investigator<br/><br/>
									&nbsp;&nbsp;&nbsp;&nbsp;e-mail: <a href="delvine@justine.umontreal.ca">delvine@justine.umontreal.ca<br /></a>
							 		&nbsp;&nbsp;&nbsp;&nbsp;phone:  (514) 345-4690
										</p>												
									</span>
								</td>
								<td style="padding-left: 0px; padding-right: 60px;" align="left" width='50%'>
									<span style="font-size:10pt; font-family: arial; vertical-align: middle;">							
										<p> 
<!--											<img alt="Dr.Nathalie Lepage" src="images/main_body/22348-wAdeli.jpg" style=" border: 1px solid blue; padding-left: 2px; float: right; padding-right: 2px; padding-top: 2px; padding-bottom: 2px;" title="Dr. Khosrow Adeli" />-->
										</p>												
									</span>
								</td>
							</tr>	
