...
<center>
	<table height="100%" width="970" border="0" cellspacing="0" cellpadding="0">
		...
		<tr><td  align="center" width="100%">
				<table height="151" width="100%" background="images/hospitals/big_caliper_montreal_stjustine.jpg">
		...
		<tr><td align="center" valign="top"  width='100%'><%@ include file="/local_hospitals/montreal/jsp/header.jsp" %></td></tr>
