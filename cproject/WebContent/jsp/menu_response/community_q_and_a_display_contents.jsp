				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=2 cellpadding=4 width='100%' style="padding: 0 0 0 10px;"> 
						<tr><td width='85%'><img src="images/common/blue_circle.gif" style="vertical-align: middle;"/>	
										  <span style="color: #519DC7; font-weight:bold;">Q&A: ${topic_cb.topic_subject}</span>
							</td>
							<td width='15%' align='right'><a onfocus=this.blur() href='<%=MenuLink.getQaLink(request.getParameter("search"),request.getParameter("stext"),request.getParameter("scategory"),Integer.parseInt(request.getParameter("section")),Integer.parseInt(request.getParameter("page"))) %>'><img src="images/common/arrow_left.gif" style="vertical-align: middle;"/>
								Back to the list</a>
							</td>
						</tr>
