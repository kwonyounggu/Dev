				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 0px 20px 20px 20px; "> 	
						    ...
						    <td colspan=4 align="left">
								<table height="40" width="100%">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
											...
											<span style="font-weight:bold; font-size:12pt; font-family: arial;">CALIPER Clinics</span>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial; ">
											<img src='images/common/location_pin.png' width=16 height=16 valign="middle"/>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #5375CB;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;CALIPER Clinics
										</td>
									</tr>	
						...
						<tr><td colspan=4 style="font-size:11pt; font-family: arial; vertical-align: middle; word-wrap: break-word; padding-right: 40px; padding-bottom: 0px; padding-left: 40px;">						
								<p><p style=" margin-left: 10.0px;"><b>To schedule your CALIPER appointment</b>, please contact Olivia Virag:</p>
								   <ul><li>phone: 905-521-2100 ext. 22263,  or</li><li>e-mail: viragoe@mcmaster.ca</li></ul>
