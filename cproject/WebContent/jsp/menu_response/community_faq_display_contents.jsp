...
<script language="Javascript" type="text/javascript">
	...
	function replyQaMessage(c_index,qa_class,name,topic_number,subject)
	{
		...
		if(mode!="qa_write")
		{
			...
			httpRequestPost("<%= MenuLink.CONTEXT %>","op=get_reply_page&sm=0&subject=Re: "+subject+"&qa_class="+qa_class+paramString,"replyQaResponse");
		}
		...
		<table border=0 cellpadding=0 cellspacing=0 bgcolor=#ffffff width="100%"> 
			...
			<tr> 
				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=2 cellpadding=4 width='100%' style="padding: 0 10px 0 10px;"> 			 		
						<tr><td colspan=2>
								<table height="40" width="100%">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
										...
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial;">
											<img src='images/common/location_pin.png' width=16 height=16 valign="middle"/>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #FCD209;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;Frequently Asked Questions
										</td>
									</tr>	
						...
						<tr>
							<td colspan=2 width='100%' align='right'><a onfocus=this.blur() href='<%=MenuLink.getFaqLink(request.getParameter("search"),request.getParameter("stext"),request.getParameter("scategory"),Integer.parseInt(request.getParameter("section")),Integer.parseInt(request.getParameter("page"))) %>'><img src="images/common/arrow_left.gif" style="vertical-align: middle;"/>
								Back to the list</a>
							</td>
						</tr>
