	...
	<table height="100%" width="970" border="0" cellspacing="0" cellpadding="0">
					...
					<tr><td align="left" valign="bottom" style="padding-left: 150px; font-size:13pt;"></td>
						<td align="right" valign="bottom" style="padding-right: 30px; ">
							<%  String admin_email=(String)session.getAttribute("admin_email"); 
								if(admin_email!=null)
									out.print("<a style='color: #4197C1; font-weight:bold; font-size:11pt; font-family: arial;' href='javascript:admin_logout()'>admin out</a>");
							%>
						</td>
					</tr>				
				</table>
			</td></tr>		
		<tr><td align="center" valign="top" width="970"><%@ include file="home_header.jsp" %></td></tr>
		...
		<tr><td align="center" width="970">
				<table cellspacing="0" cellpadding="0" height="46" width="100%" background="images/footer_970x46.gif">
					...
					<tr>
						<td align="center" valign="top" style="font-size:8pt;">Copyright &copy; 2006-2012 CaliperProject.com CaliperProject.org. All rights reserved.</td>
					</tr>
				</table>
			</td>
		</tr>
