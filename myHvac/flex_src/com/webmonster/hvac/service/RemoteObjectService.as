package com.sickkids.caliper.service
{
	...
	public class RemoteObjectService extends Actor implements IRemoteObjectService
	{
		private var _remoteObject:RemoteObject;
		[Inject] public var caliperModel:CaliperCustomReferenceIntervalModel;
		
		public function RemoteObjectService(dest:String="caliperProxy")
		{
			trace("INFO: RemoteObjectService() is called in RemoteObjectService.as");
		...
		{		
			...
			//trace("INFO: onOperationResult() is called in RemoteObjectService.as, op="+op+", e.result="+e.result);
			if(e.token.message.destination=="caliperProxy")
			{	
				switch(op)
				{
					case "getTestString":
					...
					case "getRawDataList":
						...
						break;
					case "getCustomizedRefIntervals":
						caliperModel.refIntervals=e.result as CustomizedRefIntervalInfoBean;
						dispatch(new RawDataRMIEvent(RawDataRMIEvent.GOT_CUSTOMIZED_REF_INTERVALS));
						break;
					default:
