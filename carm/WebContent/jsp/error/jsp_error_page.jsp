...
<table align='center' border='1' cellpadding='0' cellspacing='0' width='100%' class='error'>
	...
	<tr><td align='left'><p>ERROR CONTENTS:</p><p><ul><li><%= exception.toString() %>
										 <%
										 out.print(" at "+Utils.currentTimestamp()+"!!!<br><br>"+Message.inform_to_admin_about_exception+"&nbsp;&nbsp;<a href='mailto:"+Utils.csr_email_address+"?subject=CSR ERROR REPORT' style='color: #FE5734;text-decoration: underline;'>EMAIL</a>"+"<br><br>CUSTOMER IP ADDRESS: "+request.getRemoteAddr());
										 %></li></ul></p></td></tr>
