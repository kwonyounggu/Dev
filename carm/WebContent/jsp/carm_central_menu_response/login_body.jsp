...
<script language="Javascript" type="text/javascript">
	...
	{		
		...
		{	
			httpRequestPost("<%= MenuLink.CARM_CENTRAL_CONTEXT %>","op=ajax_carm_central_login_check&app_id=1&carm_login_id="+login_id.value+"&carm_login_password="+login_password.value,"loginResponse");	
		}		
	}
	...
	function resetPasswordConfirm()
	{
		...
		{	
			httpRequestPost("<%= MenuLink.CARM_CENTRAL_CONTEXT %>","op=ajax_carm_central_reset_password&carm_login_password1="+login_password1.value+"&carm_login_password2="+login_password2.value,"resetPasswordResponse");	
		}
	}
	...
	{   
		...
		{	
			httpRequestPost("<%= MenuLink.CARM_CENTRAL_CONTEXT %>","op=ajax_carm_central_forgot_pwd_check&app_id=1&carm_login_email="+login_email.value,"forgot_emailPasswordResponse");	
		}		
	}
	function forgot_emailPasswordResponse(strResponse)
	{
		...
		else if(strResponse.indexOf('false:')==-1)//not found
		{
			...
			location.replace("<%= MenuLink.CARM_CENTRAL_CONTEXT %>");
		}
		else 
		{
	...
	{
		httpRequestPost("<%= MenuLink.CARM_CENTRAL_CONTEXT %>","op=ajax_carm_central_forgot_pwd","forgotPasswordResponse");
	}
					...
					<table border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 0px 20px 20px 20px; "> 	
						    ...
						    <td colspan=4 align="left">
								<table height="40" width="100%">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
											...
											<span style="color: #32344B font-weight:bold; font-size:12pt; font-family: arial;">&nbsp;&nbsp;Cardiopulmonary Arrests Representation Module</span>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:10pt; font-family: arial; color: #32344B;">
											<img src='images/common/location_pin.png' width=16 height=16 valign="middle"/>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #FCD209;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;Cardiopulmonary Arrests Representation Module
										</td>
									</tr>	
						...
						<tr>
						    <td colspan=4 align="center">
								<p><b>Welcome to (CARM) Cardiopulmonary Arrests Representation Module</b></p>
							</td>
						</tr>
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
									<tr>
										<td align="center" width="50%">
											<img src="images/login/medication_safety_flow.gif" border="0" height="340" width="400" /> 
										</td>
						...
						<!-- <tr>
						    <td colspan=4 align="left" style="padding: 0px 40px 0px 40px;">
								<p>Research at the Center for Safety Research has shown 
									<ol>
										<li>Rating the potential preventability of cardiopulmonary arrest events.</li>
										<li>-</li>
										<li>-</li>	
										<li>-</li>
										<li>-</li>	
								...
								<p>Interested : please contact <a href="mailto:chris@sickkids.ca">Dr. Christopher Parshuram</a> </p>
								<p>Work has been supported by operational funding from Society of Critical Care Medicine (the Inaugural Patient Safety Grant, Canadian Institutes of Health Research and Physicians Services Incorporated.</p>
								<p>Ongoing Work 
									<ol>
										<li>-.</li>
										<li>-.</li>			
