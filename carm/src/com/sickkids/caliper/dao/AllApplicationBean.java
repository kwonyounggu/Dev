...
public class AllApplicationBean implements Serializable
{
	...
	{
		this.app_symbol = app_symbol.toUpperCase();
	}
	...
	{
		return "insert into all_application values(default, "+
				   " "+ app_id_revision+", "+
				   "'"+purpose_of_app+"', "+
				   "'"+app_symbol+"', "+
				   " "+number_of_groups+", "+
	...
	{
		return "update all_application set "+
					"app_id_revision=(app_id_revision+1)"+", "+
					"purpose_of_app='"+purpose_of_app+"', "+
