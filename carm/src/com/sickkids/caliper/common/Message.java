...
public class Message 
{
	...
	//public static final String admin_email="www.myesl.ca@gmail.com";
	
	public static final String login_information0="Please login through the login template at the left top corner.";
	public static final String login_information1="Please login through the login template at the left top corner.";
	public static final String login_information2="You are in login state.";
	public static final String login_information3="You have to login first.\"+\n\"\\n(※ if you are not a member, just follow a simple step to signup.)";
	public static final String login_information4="You have to login first.\"+\n\"\\n(※ if you are not a member, just follow a simple step to signup.)\\n\\nWould you like to login or signup now?";
	
	public static final String course_registration_sentry="--.\"+\n\"\\n(※ --.)";
	//public static final String course_registered="<span>CSR</span><br><br>&nbsp;&nbsp;&nbsp;&nbsp;--.<br><br>&nbsp;&nbsp;&nbsp;&nbsp;(※ -- "+
	//										     "<a href='"+Utils.my_home_page+"/"+MenuLink.community_q_and_a+"'>--</a>(www.centerforsafetyresearch.ca>--.)<br><br><a href='"+Utils.my_home_page+"'>--</a>--.";
	//public static final String course_registered_webpage="<span>--</span><br><br>&nbsp;&nbsp;&nbsp;&nbsp;--.<br><br>&nbsp;&nbsp;&nbsp;&nbsp;(※ -- "+
    //											"<a href='"+MenuLink.community_q_and_a+"'>--</a>(www.myesl.ca>--.)<br><br>--.";
	public static final String bank_account="<span>&nbsp;--,&nbsp;&nbsp;&nbsp;--: 110-292-776835,&nbsp;&nbsp;&nbsp;--</span>";
	
	public static final String no_modification="You can't modify this item.";
	
	public static final String error_report_subject="An error has occurred.";
	public static final String signup_email_subject="New/Update Login Account for EPOCH.";
	public static final String email_registation_subject="--.";
	public static final String email_password_subject="Notification from CenterForSafetyResearch.com";
	
	public static final String info_qa_writting_mode="You are in writing mode.";
	
	public static final String company_introduction="--.";
	public static final String password_information="New Password Allocation/Newly Updated Password.<br><br>Your password is as follows:<br><br>PASSWORD:&nbsp;&nbsp;";
	public static final String msg_end="<br><br><a href='"+Utils.my_home_page+"'>CenterForSafetyResearch.com</a><br><br>";
	
	public static final String classroom_accessibility="--.";
	public static final String classroom_accessibility_teacher="Please check your name and email one more time.\n\nYou are not allowed to gain an admin privilege.";
	
	//CSR
	public static final String invalid_loginID="Your LoginID is invalid.";
	
	//Epoch Esc Vote Results Today
	public static final String epoch_esc_vote_results_subject="Vote Results Today from EPOCH";
	public static final String epoch_esc_waiting_for_response_subject="Questions waiting for your responses from EPOCH";
	public static final String epoch_esc_highly_important_question_subject="[High Importance] A Question waiting for your reponses from EPOCH";
