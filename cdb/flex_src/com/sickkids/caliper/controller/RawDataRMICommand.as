		...
		override public function execute():void
		{
			...
			switch(event.type)
			{
				...
				case RawDataRMIEvent.GET_RAW_DATA_LIST:
					...
					break;
				case RawDataRMIEvent.GET_CUSTOMIZED_REF_INTERVALS:
					_remoteService.callService("getCustomizedRefIntervals", event.arg1, event.arg2, event.arg3, event.arg4, event.arg5, event.arg6, event.arg7); //arg1: instrument_name_id, arg2: system_metric
					trace("INFO: "+RawDataRMIEvent.GET_CUSTOMIZED_REF_INTERVALS+" with "+event.arg1+", "+event.arg2+", "+event.arg3+", "+event.arg4+", "+event.arg5+", "+event.arg6+", "+event.arg7+" is called in RawDataRMICommand.as");
					break;
				default: 
					trace("---2---");
					break;
