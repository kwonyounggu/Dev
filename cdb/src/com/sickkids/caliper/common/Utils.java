...
{	
		...
		public static final int SUBJECT_LIMIT=70;
		...
		public static final String[] analyte_v2=
		{
			"Alanine Aminotransferase With Piridoxal Phosphate",
			"Alanine Aminotransferase Without Piridoxal Phosphate",
			"Albumin G (Bromcresol Green)",
			"Albumin P (Bromcresol Purple)",
			"Alkaline Phosphatase 4-Nitrophenyl Phosphate",
			"Amylase",
			"Antistreptolysin-O",
			"Apolipoprotein AI",
			"Apolipoprotein B",
			"Aspartate Aminotransferase With Piridoxal Phosphate",
			"Aspartate Aminotransferase Without Piridoxal Phosphate",
			"Bilirubin Direct",
			"Bilirubin Total",
		...
		public static final String[] analyte_chart_v2=
		{
			"alt_act.gif",
			"alt.gif",
			"albumin_g.gif",
			...
			"c3.gif",
			"c4.gif",
			"creatinine_enzymatic.gif",
			"creatinine_jaffe.gif",
			"uhdl.gif",
			"gamma_glutamyl_transferase.gif",
			"haptoglobin.gif",
			"iga.gif",
			"igg.gif",
			"igm.gif",
	    ...
	    private static Map<String, String> createMap() 
	    {
    		...
    		result.put("lipase_lip","Lipase (lip)");//lipase_lip
