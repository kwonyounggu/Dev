...
public class CaliperXYDataset extends AbstractXYDataset implements XYDataset, DomainInfo, RangeInfo
{
	...
	public CaliperXYDataset()
    {
        this(4, 40);
    }

    public CaliperXYDataset(int i, int j)
    {
