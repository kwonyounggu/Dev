...
public class Phase1CompleteDataSetJune2011Bean implements Serializable
{
	 ...
	 */
	  ...
	  private double iga=0.0d;
	  private double igg=0.0d;
	  private double igm=0.0d;	
