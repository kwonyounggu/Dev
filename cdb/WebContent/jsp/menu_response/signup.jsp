		...
		<table border=0 cellpadding=0 cellspacing=0 bgcolor=#ffffff width="100%"> 
			...
			<tr> 
				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table cellpadding="0" cellspacing="0" width="100%" style="padding: 0px 20px 20px 20px; "> 
						<tr>
						    <td align="left">
								<table height="40" width="100%">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
											...
											<span style="font-weight:bold; font-size:12pt; font-family: arial;">Sign Up</span>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial;">
											<img src='images/common/location_pin.png' width=16 height=16 valign="middle"/>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #5375CB;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;Sign Up
										</td>
									</tr>	
						...
						<tr><td valign="top" align="left" style="padding: 0 0 0 20px;">
								<img src="images/common/arrow_dot.jpg" style="vertical-align: middle;" onload="getAgreement()"/>
			        	...
			        	<tr><td width="100%" style="padding: 0 20px;" id="agreement_box"></td></tr> 
			             <tr>
						   ...
						   <tr><td height="10"></td> </tr>
						   <tr><td valign="top" align="left"   style="padding-right: 40px; padding-bottom: 0px; padding-left: 40px; ">
									<img src="images/common/arrow_dot.jpg" style="vertical-align: middle;"/>
			<span style="color: #519DC7; font-weight:bold; font-size:12pt; font-family: times, 'Times New Roman', serif;">Sign Up</span>									
							   </td>
							</tr>
			        </table> 
					<!-- Registration Table Form -->
					<table border=0 cellspacing=0 cellpadding=4 width='95%'   style="padding-right: 40px; padding-bottom: 0px; padding-left: 40px; "> 
				 		<tr><td colspan=4 height=1 class=dv_line></td></tr> 
	 					<tr> 
							<td class=left_td><span style="color: #000000;">*</span>&nbsp;&nbsp;Login Email</td> 
						...
						<tr><td colspan=4 height=1 class=dv_line></td></tr> 
						<tr> 
							<td class=left_td><span style="color: #000000;">*</span>&nbsp;&nbsp;Password</td> 
							<td class=check_td></td> 
							<td colspan=2 align="left">
						...
						<tr> 
							...
							<td class=left_td><span style="color: #000000;">*</span>&nbsp;&nbsp;Your Name</td> 
							<td class=check_td></td> 
							<td colspan=2 align="left"> 
						...
						<tr><td colspan=4 height=1 class=dv_line></td></tr> 
						<tr> 
							<td class="left_td"><span style="color: #000000;">*</span>&nbsp;&nbsp;Address</td> 
							<td class=check_td></td> 
							<td colspan=2 > 
								<input type=text name="reg_address" size=38 value="" maxlength=200 class=input_text style='letter-spacing:-1;' />
						...
						<tr> 
							<td colspan=4 align=center><br> 
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<span style="color: #000000;">*</span>:&nbsp;&nbsp;<span>You must fill in.)</span>
							</td> 
						</tr> 
					 </table> 	
				</td> 
