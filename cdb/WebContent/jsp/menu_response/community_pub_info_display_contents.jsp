			...
			<tr> 
				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=2 cellpadding=4 width='100%' style="padding: 0 0 0 10px;"> 
						<tr><td width='85%'><img src="images/common/blue_circle.gif" style="vertical-align: middle;"/>	
										  <span style="color: #519DC7; font-weight:bold;">Public Notice: ${topic_cb.topic_subject}</span>
							</td>
							<td width='15%' align='right'><a onfocus=this.blur() href='<%=MenuLink.getPubLink(request.getParameter("search"),request.getParameter("stext"),request.getParameter("scategory"),Integer.parseInt(request.getParameter("section")),Integer.parseInt(request.getParameter("page"))) %>'><img src="images/common/arrow_left.gif" style="vertical-align: middle;"/>
								Back to the list</a>
							</td>
						</tr>
	 						...
	 						for(int i=0;i<qa_contents_list.size();i++)
	 						{
	 							...
	 							out.print("<tr><td height=26 style='border-style: dotted;border-width: 1px;border-color: #CBCCC6;'>");
	 								out.print("<table border=0 cellspacing=0 cellpadding=4 width='100%' >");
	 									...
	 									if(((CommunityBean)qa_contents_list.get(i)).getTopic_subject().length()>(Utils.SUBJECT_LIMIT+10))
	 										out.print(((CommunityBean)qa_contents_list.get(i)).getTopic_subject().substring(0,(Utils.SUBJECT_LIMIT+10))+"</td>");
	 									else
	 									...
	 									//String sRes=qa_contents_list.get(i).getIn_response_to();
	 									//if(!(sRes==null||sRes.equals("")||sRes.equals("0")))
	 									//{	
	 									//	String[] temp=sRes.split(":");
	 									//	if(!(temp==null || temp.length<2))
	 									//		out.print("|&nbsp;수신: "+temp[1]+"님&nbsp;");
	 									//}
	 									//out.print("|&nbsp;<a onfocus=this.blur() href='#' onclick=\"if(check_login()) replyQaMessage("+qa_contents_list.get(i).getCommunity_index()+","+
	 									//																						qa_contents_list.get(i).getQa_class()+",'"+
						 				//																					    qa_contents_list.get(i).getPerson_name()+"',"+
						 				//																					    qa_contents_list.get(i).getTopic_number()+",'"+
						 				//																					    qa_contents_list.get(i).getTopic_subject()+"'); return false;\">"+
						 				//																					   "<img src='images/common/reply.gif' style='vertical-align: middle;'>답글</a>");
