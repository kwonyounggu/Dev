		...
		<table border=0 cellpadding=0 cellspacing=0 bgcolor=#ffffff width="100%"> 
			...
			<tr> 
				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 20px 20px 20px 20px; "> 	
						<tr>
						    <td colspan=4 align="left">
								<img src="images/common/blue_circle.gif" style="vertical-align: middle;"/><span style="color: #519DC7; font-weight:bold; font-size:12pt; font-family: arial;">&nbsp;&nbsp;CALIPER across Canada</span>
							</td>
						</tr>
