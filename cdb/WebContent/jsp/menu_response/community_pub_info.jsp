			...
			<tr> 
				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=2 cellpadding=4 width='100%' style="padding: 0 0 0 10px;"> 
				 		<tr>
						    <td colspan=4>
								<img src="images/common/blue_circle.gif" style="vertical-align: middle;"/><span style="color: #519DC7; font-weight:bold; font-size:12pt; font-family: times, 'Times New Roman', serif;">Public Notice</span>
							</td>
						</tr>
						...
						<%  //do error handler
							...
							for(int j=0;j<qa_msg_list.size();j++)
							{
								...
								out.print("<img src='images/common/attention.gif' style='vertical-align: middle;'/>&nbsp;");
						...
						<tr>
							...
							<td width='56%' >
										...
										<input type='hidden' name='op' value='menu_community_pub_info'>
									...
									<% 
										...
										if(search!=null && search.equals("1") && request.getParameter("stext")!=null)
											out.print("<a onfocus=this.blur() href='"+"MenuLink.community_pub_info"+"'><img src='images/common/arrow_left.gif' style='vertical-align: middle; cursor:pointer;' />Back</a>");
									%>
							...
							<%  String login_email=(String)session.getAttribute("login_email"); 
								if(login_email!=null && login_email.equals(Utils.caliper_email_address))
									out.print("<img src='images/common/write_btn.gif' style='cursor:pointer;' onclick='if(check_login()) writeQaMessage();'/>");
							%>								
							</td>
						</tr> 
					 </table> 	
