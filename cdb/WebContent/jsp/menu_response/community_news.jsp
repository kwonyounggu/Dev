		...
		<table border=0 cellpadding=0 cellspacing=0 bgcolor=#ffffff width="100%"> 
			...
			<tr> 
				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=2 cellpadding=4 width='100%' style="padding: 0 20px 20px 10px;"> 
				 		<tr>
						    <td colspan=4>
								<table height="40" width="710" background="images/common/title.gif">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
											...
											<%  String admin_email=(String)session.getAttribute("admin_email"); 
												if(admin_email!=null)
													out.print("<a style='color: #4197C1 font-weight:bold; font-size:8pt; font-family: arial;' href='javascript:admin_logout()'>admin out</a>");
												else
													out.print("<a style='color: #4197C1 font-weight:bold; font-size:8pt; font-family: arial;' href='javascript:checkAdminLogin()'>admin in</a>");
											%>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial; color: #ffffff;">
											<img src='images/common/location_pin.png' width=16 height=16>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #FCD209;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;Community News
										</td>
									</tr>					
								</table>								
							</td>
