				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 0px 20px 20px 20px; "> 	
						    ...
						    <td colspan=4 align="left">
								<table height="40" width="710" background="images/common/title.gif">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
											<span style="color: #ffffff; font-weight:bold; font-size:12pt; font-family: arial;">&nbsp;&nbsp;CALIPER via Youtube</span>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial; color: #ffffff;">
											<img src='images/common/location_pin.png' width=16 height=16>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #FCD209;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;CALIPER via Youtube
										</td>
									</tr>					
								</table>
							</td>
						...
						<tr><td colspan=4>
							...
							<p>A national initiative coordinated by clinical laboratories at The Hospital for Sick Children (SickKids, Toronto) and Children's Hospital of Eastern Ontario (CHEO, Ottawa).</p>
							<p>A research project among <a href="#" onfocus="this.blur()" title="" style="color: #519DC7;">children’s hospitals across Canada</a> including Toronto, Ottawa, Hamilton, Montreal, St. John’s,Saskatoon, and Vancouver.</p>
							...
							<p align="center">
								<object style="height: 390px; width: 640px"><param name="movie" value="http://www.youtube.com/v/hqiNL4Hn04A?version=3"><param name="allowFullScreen" value="true"><param name="allowScriptAccess" value="always"><embed src="http://www.youtube.com/v/hqiNL4Hn04A?version=3" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="640" height="390"></object>
							</p>
							...
							Initiative on Paediatric Reference Interval database (CALIPER database), is a key project of the
							...
							<p align="center">
								<object style="height: 390px; width: 640px"><param name="movie" value="http://www.youtube.com/v/R8ceDC8wWRs?version=3"><param name="allowFullScreen" value="true"><param name="allowScriptAccess" value="always"><embed src="http://www.youtube.com/v/R8ceDC8wWRs?version=3" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="640" height="390"></object>
							</p>
							</span>
							</td>
						</tr>		
