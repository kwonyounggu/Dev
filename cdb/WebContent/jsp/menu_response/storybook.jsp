				...
				<td  bgcolor=#ffffff valign="top" align="left"> 
					<table border=0 cellspacing=0 cellpadding=0 width='100%' style="padding: 0px 20px 20px 20px; "> 	
						    ...
						    <td colspan=4 align="left">
								<table height="40" width="710" background="images/common/title.gif">
									<tr><td align="left" valign="middle" style="padding-left: 20px; font-size:13pt;">
											<span style="color: #ffffff; font-weight:bold; font-size:12pt; font-family: arial;">&nbsp;&nbsp;CALIPER Story Book</span>
										</td>
										<td align="right" valign="middle" style="padding-right: 20px; font-size:8pt; font-family: arial; color: #ffffff;">
											<img src='images/common/location_pin.png' width=16 height=16>&nbsp;&nbsp;<a href="<%= MenuLink.home %>" style="color: #FCD209;">Home</a>&nbsp;&nbsp;>&nbsp;&nbsp;CALIPER Story Book
										</td>
									</tr>					
								</table>
							</td>
						...
						<tr><td colspan=4 style="font-size:10pt; font-family: arial; vertical-align: middle; word-wrap: break-word;">						
								<p><p><a href="pdf/17028-wCALIPER_book1.pdf" title=""><img align="left" alt="CALIPER: Story book front cover" hspace="10" src="images/main_body/17029-wFrontCover.jpg" title="Click here to open the CALIPER Story book" vspace="0" /></a></p><p>The book is a pdf file (1.6 Mb), and you need Adobe Reader 8.0 on your computer to be able to open and see it.</p><p>Click the <strong>'Cal &amp; Cali CALIPER'</strong> image to read the Story book.</p></p>
							</td>
						</tr>		
