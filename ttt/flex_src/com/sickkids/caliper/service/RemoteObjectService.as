package com.sickkids.caliper.service
{
	...
	public class RemoteObjectService extends Actor implements IRemoteObjectService
	{
		...
		public function RemoteObjectService(dest:String="carmProxy", endpoint:String="{FlexGlobals.topLevelApplication._host}/carm/messagebroker/amf")
		{
			trace("INFO: RemoteObjectService() is called in RemoteObjectService.as, endpoint="+endpoint);
