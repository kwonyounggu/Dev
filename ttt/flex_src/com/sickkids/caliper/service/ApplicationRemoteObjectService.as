package com.sickkids.caliper.service
{
	...
	public class ApplicationRemoteObjectService extends Actor implements IApplicationRemoteObjectService
	{
		private var _remoteObject:RemoteObject;
		[Inject] public var appModel:ApplicationModel;
		
		public function ApplicationRemoteObjectService(dest:String="carmProxy", endpoint:String="{FlexGlobals.topLevelApplication._host}/carm/messagebroker/amf")
		{
			trace("INFO: ApplicationRemoteObjectService() is called in ApplicationRemoteObjectService.as, endpoint="+endpoint);
		...
		{		
			...
			trace("INFO: onOperationResult() is called in ApplicationRemoteObjectService.as, op="+op+", e.result="+e.result);
