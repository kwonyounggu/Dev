...
{	
	...
	public class TttNetCallCommand extends Command
	{
		[Inject] public var event:TttNetCallEvent;
		[Inject] public var _netConnectionService:INetConnectionService;
		
		public function TttNetCallCommand()
		{
			super();
		}
		...
		override public function execute():void
		{
			...
			trace("INFO: execute() is called in TttNetCallCommand.as, "+event.type+", arg1="+event.arg1);
			switch(event.type)
			{
				case TttNetCallEvent.CALL_TO_METHOD_EVENT:
					 _netConnectionService.callService(event.method as String, event.res as Responder, event.arg1 as String);
					 break;
				...
				case CapRMIEvent.CHECK_SIGNIN_EVENT:
					...
					trace("INFO: "+CapRMIEvent.CHECK_SIGNIN_EVENT+", "+event.arg1+", "+event.arg2+", "+event.arg3+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.SAVE_PWD_EVENT:
					...
					trace("INFO: "+CapRMIEvent.SAVE_PWD_EVENT+", "+event.arg1+", "+event.arg2+", "+event.arg3+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.SEND_LOGIN_INFO_EVENT:
					_netConnectionService.callService("sendLoginInfo", event.arg1, event.arg2);//appId, email
					trace("INFO: "+CapRMIEvent.SEND_LOGIN_INFO_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_ITEM_LIST_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_ITEM_LIST_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_CLINICAL_SUMMARY_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_CLINICAL_SUMMARY_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_DIAGNOSES_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_DIAGNOSES_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_PROBLEMS_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_PROBLEMS_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_LABOROTORY_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_LABOROTORY_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_VITALSIGN_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_VITALSIGN_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_MEDICATION_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_MEDICATION_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_RADIOLOGY_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_RADIOLOGY_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				case CapRMIEvent.GET_QPOINTS_EVENT:
					...
					trace("INFO: "+CapRMIEvent.GET_QPOINTS_EVENT+", "+event.arg1+", "+event.arg2+" is called in TttNetCallCommand.as");
					break;
				*/
				default: 
					trace("INFO: UNKWON REQUEST is called in TttNetCallCommand.as");
					break;
			}
		}
	}
