package com.sickkids.caliper.events
{
	...
	public class HomeRMIEvent extends Event
	{
		...
		public static const GET_APP_LIST:String="GET_APP_LIST";
		public static const GOT_APP_LIST:String="GOT_APP_LIST";
		...
		public function HomeRMIEvent(type:String, arg1:Object=null, arg2:Object=null, arg3:Object=null, arg4:Object=null, arg5:Object=null, arg6:Object=null, bubbles:Boolean=false, cancelable:Boolean=false)
		{
			_arg1=arg1;
			_arg2=arg2;
			_arg3=arg3;
		...
		{
			return new HomeRMIEvent(type, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, bubbles, cancelable);
		}
	}
}