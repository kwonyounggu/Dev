...
{	
		...
		public static String	ttt_manager_email_id;
		public static String	ttt_manager_name;
		...
		public static int ttt_senior_seniority=0;//will be changed by general_information.properties
	    ...
	    static 
	    {
	        try 
	        {
            	...
            	ttt_manager_email_id=bundle.getString("ttt_manager_email_id");
            	ttt_manager_name=bundle.getString("ttt_manager_name");          	
            	
            	ttt_senior_seniority=Integer.parseInt(bundle.getString("ttt_senior_seniority"));
