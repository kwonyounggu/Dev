...
public class MailInfoWithAttachment extends Authenticator implements Runnable
{
      ...
      public MailInfoWithAttachment(String from, List<String> to, List<String> name, String server, String subject, String message, String fileName) 
      {
    	  	this.fromAddr = from;
	        this.toAddr = to;
	        this.name = name;
