...
public class UAgentInfo
{
	...
	public boolean detectWindowsMobile()
	{
		...
		if (userAgent.indexOf(devicePpc) != -1
				&& !(userAgent.indexOf(deviceMacPpc) != -1)) return true;
	 ...
	 * Storm or Torch. Excludes the Playbook.
	 * 
	...
	{
		if (detectBlackBerry()
				&& (userAgent.indexOf(deviceBBStorm) != -1 || userAgent
						.indexOf(deviceBBTorch) != -1))
		{
			return true;
		}
		return false;
	 ...
	 * Tour, Curve2 Excludes the new BlackBerry OS 6 browser!!
	 * 
	...
	{
		return (isIphone || isAndroidPhone || isTierIphone
				|| detectS60OssBrowser() || detectSymbianOS()
	 ...
	 * iPad, Android (e.g., Xoom), BB Playbook, etc.
	 * 
	...
	public boolean detectTierRichCss() 
	{
	     ...
	     if (detectMobileQuick()) 
	     {
	                     ...
	                     if (detectWebkit()
	                    		 ...
	                    		 || detectWindowsPhone7() 
	                    		 || detectWindowsMobile()
	                    		 || userAgent.indexOf(engineTelecaQ) != -1) return true;
	     }
	     return false;
	}
	...
	public boolean detectTierOtherPhones()
	{
		...
		if (detectMobileLong() && !detectTierIphone() && !detectTierRichCss())return true;
		return false;
	}
}
